...
const Footer = () => {
  ...
  const footerLinks = [
    {
      title: "Product",
      links: ["Features", "Pricing", "API", "Integrations", "Enterprise"],
    },
    {
      title: "Company",
  ...
  return (
    <footer className="bg-black/80 backdrop-blur-sm border-t border-white/20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Cognito AI Technologies. All rights
            reserved. Built with passion for AI innovation.
          </p>
        </div>
      </div>
    </footer>
