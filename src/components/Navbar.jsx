...
function Navbar({ setIsActive }) {
  ...
  return (
    <div className="flex items-center justify-between px-2 md:px-4 mb-8 md:mb-4">
      ...
      <button
        type="button"
        className="upgrade inline text-sm md:text-md text-text px-6 py-2 font-semibold rounded-full bg-[linear-gradient(120deg,rgba(137,247,254,0.7)_0%,rgba(102,166,255,0.7)_100%)] cursor-pointer"
